  ...
  public: {
    Tables: {
      ...
      variable_budget_periods: {
        ...
        Relationships: [
          {
            foreignKeyName: "variable_budget_periods_family_id_fkey";
            columns: ["family_id"];
            isOneToOne: false;
            referencedRelation: "families";
            referencedColumns: ["id"];
    ...
    Enums: {
      expense_nature: "fixo" | "variavel";
      account_type:
        "corrente" | "digital" | "poupanca" | "dinheiro" | "carteira" | "investimento" | "outros";
      category_kind: "receita" | "despesa";
      invoice_status: "aberta" | "fechada" | "paga";
      recurrence_frequency:
        "semanal" | "mensal" | "bimestral" | "trimestral" | "semestral" | "anual";
      transaction_status: "previsto" | "pendente" | "pago" | "atrasado" | "cancelado";
      transaction_type: "receita" | "despesa" | "transferencia" | "pagamento_fatura";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
